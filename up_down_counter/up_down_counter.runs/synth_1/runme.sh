...
HD_PWD='C:/Users/Bavan2002.DESKTOP-TITUVCT/Desktop/up_down_counter/up_down_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log up_down_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source up_down_counter.tcl
