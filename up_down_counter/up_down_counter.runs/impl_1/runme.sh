...
HD_PWD='C:/Users/Bavan2002.DESKTOP-TITUVCT/Desktop/up_down_counter/up_down_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log up_down_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source up_down_counter.tcl -notrace
